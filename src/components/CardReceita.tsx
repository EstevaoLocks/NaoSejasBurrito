        ...
        <div className="cardReceitaSemana">
            ...
            <div className="containerEsquerda-receitaSemana">
                <div className="imgReceitaSemana-container">
                    ...
                    <figure>
                        <img src={imgReceita} alt="Imagem ilustrativa da receita" />
                    </figure>
                ...
                <header className="titleReceitaSemana-container">
                    <div className="titleReceitaSemana">
                        <p className="categoriaReceitaSemana">{Receita.getReceita(receita, "categoria")}</p>
                        <h3 className="subtitleTertiary">{Receita.getReceita(receita, "nome")}</h3>
                    </div>
                    <p className="textReceitaSemana">{Receita.getReceita(receita, "descricao")}</p>
                </header>

                {/* Ingredientes da receita da semana */}
                {Receita.getReceita(receita, "ingredientes")}
            </div>

            {/* Div da direita do card */}
            <div className="containerDireita-receitaSemana">
                {/* Lista do modo de preparo da receita da semana */}
                {Receita.getReceita(receita, "modoPreparo")}
