...
import ChilliMexicano from './../assets/img/Chilli-mexicano.jpg'
                ...
                <div className="cardReceitaSemana">
                    ...
                    <div className="containerEsquerda-receitaSemana">
                        <div className="imgReceitaSemana-container">
                            ...
                            <figure>
                                <img src={ ChilliMexicano } alt="Imagem de Tacos mexicanos recheados com carne, tomat, cebola..." />
                            </figure>
                        ...
                        <header className="titleReceitaSemana-container">
                            <div className="titleReceitaSemana">
                                <p className="categoriaReceitaSemana">Caldos</p>
                                <h3 className="subtitleTertiary">Chili Mexicano</h3>
                            </div>
                            <p className="textReceitaSemana">
                                O Chili Mexicano é um prato tradicional da culinária mexicana, conhecido por sua combinação de sabores picantes e reconfortantes. Ele é feito com carne moída, feijão, tomate, cebola e uma variedade de temperos, como cominho, pimenta chili e alho.
                            </p>
                        </header>
                        ...
                        <div className="receitaReceitaSemana-container">
                            ...
                            <ul className="ingredientesReceitaSemana">
                                <li className="itemIngredienteReceitaSemana">1 ½ xícara (chá) de feijão-rosinha</li>
                                <li className="itemIngredienteReceitaSemana">1 cebola bem picada</li>
                                <li className="itemIngredienteReceitaSemana">3 colheres (sopa) de óleo</li>
                                <li className="itemIngredienteReceitaSemana">500 gramas de coração de alcatra moído</li>
                                <li className="itemIngredienteReceitaSemana">3 dentes de alho amassado</li>
                                <li className="itemIngredienteReceitaSemana">1 colher (chá) de mix d e pimentas: 1 colher (chá) de pimenta vermelha seca + 1 colher (chá) de pimenta- do- reino e pimenta branca + 1 colher (chá) de pimenta jamaicana</li>
                                <li className="itemIngredienteReceitaSemana">2 ½ tomates</li>
                                <li className="itemIngredienteReceitaSemana">2 colheres (chá) de sal</li>
                                <li className="itemIngredienteReceitaSemana">1 colher (sopa) de páprica doce</li>
                                <li className="itemIngredienteReceitaSemana">1 colher (chá) de cominho</li>
                                <li className="itemIngredienteReceitaSemana">Pimenta do reino á gosto</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="containerDireita-receitaSemana">
                        ...
                        <div className="modoPreparoReceitaSemana-container">
                            <h3 className="posSubtitleTertiary">Modo de Preparo:</h3>
                            <ul className="modoPreparoReceitaSemana">
                                <li className="itemModoPreparoReceitaSemana">Primeiramente, lave o feijão e despeje em uma panela de pressão. Cubra com água a panela.</li>
                                <li className="itemModoPreparoReceitaSemana">Leve ao fogo até que pegue pressão. A partir daí, deixe no máximo por mais 20 minutos em fogo alto.</li>
                                <li className="itemModoPreparoReceitaSemana">Logo em seguida, coe o feijão e reserve.</li>
                                <li className="itemModoPreparoReceitaSemana">Em uma panela, coloque o óleo e refogue o alho e a cebola e acrescente a carne moída.</li>
                                <li className="itemModoPreparoReceitaSemana">Mexa até que comece a dessorar a carne.</li>
                                <li className="itemModoPreparoReceitaSemana">Então, acrescente uma colher ( chá) do mix de pimentas e misture. A pimenta aqui é a gosto, você pode usar na Receita de Chilli Mexicano as que mais tem costume.</li>
                                <li className="itemModoPreparoReceitaSemana">Por fim, assim que a carne estiver dourada, acrescente os tomates, a páprica doce e o cominho. Deixe cozinhar por 20 minutos.</li>
                                <li className="itemModoPreparoReceitaSemana">Se precisar, acrescente um pouco de água. Prove o sal e acrescente os grãos do feijão.</li>
                                <li className="itemModoPreparoReceitaSemana">Deixe a Receita de Chilli Mexicano cozinhar por mais 10 minutos e desligue o fogo. Salpique salsinha ou queijo por cima, fica ótimo.</li>
                                <li className="itemModoPreparoReceitaSemana">Sirva com as tortillhas e salsa mexicana, fica delicioso.</li>
                            </ul>
                        </div>

                        {/* Logo */}
                        <div className="logo-container">
                            <a href="../../../../index.html#pageHeader"><h2 className="logo-cardReceitaSemana">Não sejas burrito!</h2></a>
                        </div>
                    </div>
